# PyPlexity
# Python implementation of perplexity
...
# The perplexity model expects an array of strings where each string represents a sentence
# A sentence is defined as each word separated by white space, including punctuations
